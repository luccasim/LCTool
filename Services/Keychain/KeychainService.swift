...
protocol KeychainServiceProtocol {
    ...
    func addCredentialWithBiometric(server: String, credentials: KeychainService.Credentials) async throws
    func getCredentialWithBiometric(server: String) async throws -> KeychainService.Credentials
...
extension KeychainService: FreeKeychainServiceProtocol {}
